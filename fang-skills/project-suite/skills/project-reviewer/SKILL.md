...
2. **上游 Confidence 检查** → 读 `state.json` history → 检查 generator/tester 的 confidence → <70 则审查强度自动升至 HIGH。 → [../../runtime/engine/confidence-gate.md](../../runtime/engine/confidence-gate.md)
